...
<body id="app-container" class="menu-default show-spinner sample-4">
    <div class="menu">
        <!-- sitebart -->
        <div class="main-menu">
            <div class="scroll">
        ...
        <nav class="navbar fixed-top" style="padding: 1.5rem 0 10rem 5rem;">
            <div class="d-flex align-items-center navbar-left">
                ...
                <div class="left-portion-header">
                    ...
                    <p>Current Lesson - What is alcohol?</p>
                ...
                <div class="chapter-slider">
                    <div class="slider">
                        ...
                        <input type="range" min="0" max="5" value="4" onchange="rangevalue.value=value" />
   ...
   <script src="js/vendor/quill.min.js"></script>
    ...
    <script src="js/sample-4.js"></script>
</body>
