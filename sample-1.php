...
<body id="app-container" class="menu-default show-spinner">
        ...
        <nav class="navbar fixed-top" style="padding: 1.5rem 0 10rem 5rem;">
            <div class="d-flex align-items-center navbar-left">
                ...
                <div class="left-portion-header">
                    ...
                    <p>Current Lesson - Intro to Cocktails (Linear)</p>
                ...
                <div class="chapter-slider">
                    <div class="slider">
                        <span>Lesson<output id="rangevalue"> 1</output></span>
                        <input type="range" min="0" max="5" value="1" onchange="rangevalue.value=value" />
   ...
   <script src="js/vendor/quill.min.js"></script>
    ...
    <script src="js/sample-1.js"></script>
</body>
