            ...
            <div class="d-flex align-items-center navbar-left">
                ...
                <div class="chapter-slider">
                    <div class="slider">
                        ...
                        <input type="range" min="0" max="10" value="0" onchange="rangevalue.value=value" />
                ...
                <div class="modal-header flex-column">
                    ...
                    <div class="unit-color-section w-100">
                        ...
                        <div class="unit-label-section d-flex align-items-center justify-content-between">
                            ...
                            <span class="class-name static-title right" contentEditable="true" onkeypress="return (this.innerText.length <= 30);">No text</span>
