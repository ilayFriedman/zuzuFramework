...
<body id="app-container" class="menu-default show-spinner sample-5">
    <div class="menu">
        <!-- sitebart -->
        <div class="main-menu">
            <div class="scroll">
        ...
        <nav class="navbar fixed-top" style="padding: 1.5rem 0 10rem 5rem;">
            <div class="d-flex align-items-center navbar-left">
                ...
                <div class="left-portion-header">
                    ...
                    <p>Current Lesson - Bartendering Main</p>
                ...
                <div class="chapter-slider">
                    <div class="slider">
                        ...
                        <input type="range" min="0" max="5" value="5" onchange="rangevalue.value=value" />
