...
<body id="app-container" class="menu-default show-spinner sample-3">
    <div class="menu">
        <!-- sitebart -->
        <div class="main-menu">
            <div class="scroll">
                ...
                <ul class="list-unstyled bottom-menu">
                    ...
                    <li>
                        <a href="sample-6.php" target="_blank">
        ...
        <nav class="navbar fixed-top" style="padding: 1.5rem 0 10rem 5rem;">
            <div class="d-flex align-items-center navbar-left">
                ...
                <div class="left-portion-header">
                    ...
                    <p>Current Lesson - Intro to Cocktails (Deep)</p>
                ...
                <div class="chapter-slider">
                    <div class="slider">
                        <span>Lesson<output id="rangevalue"> 3</output></span>
                        <input type="range" min="0" max="5" value="3" onchange="rangevalue.value=value" />
   ...
   <script src="js/vendor/quill.min.js"></script>
    ...
    <script src="js/sample-3.js"></script>
</body>
