...
// end chart drawflow
  ...
  $('body').addClass('changeCursor');
	...
	$('body').on('click','.modal-footer .editupdate',function(){
		...
		if(colorcode=='#009BF2'){colorcode='thumbnail';}
		if(colorcode){}else{
			colorcode='thumbnail';
		}
...
if(colorcode=='#009BF2'){colorcode='thumbnail';}
	...
	$('#drawflow').find('#node-3').closest('.parent-node').append('<svg class="connection  node_in_node-3 node_out_node-2 output_1 input_2 connection-blue-row" data-in="node-3"><path class="main-path" d=" M 151.66666666666663 270.83334604899088 C 270.08334096272782 270 270 270.0000025431315 226.500015258789  270.0000025431315" style="stroke:#009BF2"></path></svg>');
	$('#drawflow').find('#node-4').closest('.parent-node').append('<svg class="connection node_in_node-4 node_out_node-3 output_1 input_2 connection-blue-row" data-in="node-4"><path class="main-path" d=" M 380.5 271 C 411 271 411 271 441.5  271" style="stroke:#009BF2"></path></svg>');
	$('#drawflow').find('#node-5').closest('.parent-node').append('<svg class="connection node_in_node-5 node_out_node-4 output_1 input_2 connection-blue-row" data-in="node-5"><path class="main-path selected" d=" M 594.5 271 C 625.5 271 625.5 271 656.5  271" style="stroke:#009BF2"></path></svg>');
