                      ...
                      <li> <div class="glyph">
                             ...
                             <!-- <li class="user-img"><img src="img/user.svg"></li> -->
                                      ...
                                      <!--   <h4>Explanation </h4> -->
                                        ...
                                        <p>Once fermented, the liquid is distilled through either a column still or a pot still. The still's heat forces the alcohol in the fermented liquid to evaporateâ€”alcohol has a lower boiling point than water. The water is left behind, but the alcohol vapor is forced into the next stage of the still, such as a series of coils or another pot, depending on the setup. When the vapor is cooled, it condenses and creates a concentrated alcohol liquid that is so strongâ€”high alcohol by volume (ABV), or proofâ€”that it is undrinkable.</p>
                                       <!--  <p>At the end of distillation, the strong alcohol is collected. It may then be filtered, aged, or flavored (or a combination of any or all three) and diluted with water to the bottling strength. The exact process depends on the type of liquor being madeâ€”for instance, gin is flavored within the stillâ€”and each distiller's preferred method for any of the distillation steps.</p> -->
