                    ...
                    <li>
                        ...
                        <div id="collapseAuthorization" class="collapse show">
                            <ul class="list-unstyled inner-level-menu">
                                <li>
                                    <a href="#">
                                        <i><img src="img/clapperboard.png" style="padding-right: 0px;"></i> <span
								...
								<li>
                                    <a href="#">
                                        <i><img src="img/signing.png" style="padding-right: 0px;"></i> <span
                                            class="d-inline-block" style="height: 22px;font-size: 16px">Exercise: Tequila Sunrise</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i><img src="img/open-book.png" style="padding-right: 0px;"></i> <span
...
<div class="modal fade modal-right sidebarpopup" id="exampleModalRight" tabindex="-1" role="dialog"
                       ...
                       <select class="vodiapicker">
                            <option value="en" class="test" data-thumbnail="img/eyeicon.png">
                               <!--  <div class="class-name" style="font-weight:600">Choose Unit</div> -->
                            </option>
                            <option value="uk" data-thumbnail="img/video-icon.png" class="rounded-circle">Video</option>
                            <option value="cn" data-thumbnail="img/text-icon.png" class="rounded-circle">Text</option>
                            <option value="de" data-thumbnail="img/exam-icon.png" class="rounded-circle">Exam</option>
                        </select>
