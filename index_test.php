...
Looks like Joe may need your help!
       ...
       <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="wrapper">
                        <div class="col-right right_box"> <!-- added new claa --> 
                                           ...
                                           <div class="main-icons">
												<ul class="list-unstyled list-inline">
													...
													<li class="for-edit-option">
														<div class="class-name static-title" contentEditable="true" style="font-weight:600;max-width:110px; max-height:50px;overflow:hidden;" onkeypress="return (this.innerText.length <= 10);">Choose Unit</div>
                                            ...
                                            <li class="radio-btns">
                                              ...
                                              <li>
                                                    <div class="chapter-slider1">
                                                      ...
                                                      <input type="range" id="rangeslide" min="0" max="10" onchange="rangevalue.value=value"/>
                                                        
                                                      </div>
                                                      <div class="range-per-text">50%</div>
                                                    </div>
                                              </li>
                                        </ul>
                                        </div>
